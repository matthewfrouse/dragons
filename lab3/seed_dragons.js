...
function pushToDragonStatsTableOne(){
    ...
    return DDB.batchWriteItem(params).promise().catch((err) => console.log('caught error'));
}
...
function pushToDragonCurrentPowerTable(){
    ...
    return DDB.batchWriteItem(params).promise().catch((err) => console.log('caught error loading dragon current power'));
}
function pushToDragonBonusAttackTable(){
    ...
    return DDB.batchWriteItem(params).promise().catch((err) => console.log('caught error loading bonus attack'));
}
function pushToDragonFamilyTable(){
    ...
    return DDB.batchWriteItem(params).promise().catch((err) => console.log('caught error loading dragon family'));
}
